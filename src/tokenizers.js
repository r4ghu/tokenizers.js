...
} from './utils/whisper/common_whisper.js';
...
export class PreTrainedTokenizer extends Callable {
    ...
    /**
     * @typedef {number[]|number[][]} BatchEncodingItem
     * 
     ...
     * 
     * const input_ids = tokenizer.apply_chat_template(chat, { tokenize: true});
     ...
     * @returns {string | number[]| number[][]|BatchEncoding} The tokenized output.
     */
